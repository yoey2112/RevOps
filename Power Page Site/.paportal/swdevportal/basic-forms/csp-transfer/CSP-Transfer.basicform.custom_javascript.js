...
$(document).ready(function () {
  ...
  function loadConfigData() {
    const configScript = document.getElementById('csp-config-data');
  ...
  function loadOrgsData() {
    const orgsScript = document.getElementById('csp-orgs-data');
  ...
  function loadAccountsData() {
    const accountsScript = document.getElementById('csp-accounts-data');
  ...
  function updateCaseTitleFromOrg(orgId) {
    ...
    const org = getOrgById(orgId);
    if (org && org.name) {
      const caseTitle = `CSP Transfer for ${org.name}`;
  ...
  function injectModalStyles() {
    const styleId = 'csp-modal-centering-styles';
