...
$(document).ready(function () {
  ...
  function loadConfigData() {
    const configScript = document.getElementById('godaddy-config-data');
  ...
  function loadOrgsData() {
    const orgsScript = document.getElementById('godaddy-orgs-data');
  ...
  function loadAccountsData() {
    const accountsScript = document.getElementById('godaddy-accounts-data');
  ...
  function updateCaseTitleFromOrg(orgId) {
    ...
    const org = getOrgById(orgId);
    if (org && org.name) {
      const caseTitle = `CSP GoDaddy Transfer for ${org.name}`;
  ...
  function injectModalStyles() {
    const styleId = 'godaddy-modal-centering-styles';
