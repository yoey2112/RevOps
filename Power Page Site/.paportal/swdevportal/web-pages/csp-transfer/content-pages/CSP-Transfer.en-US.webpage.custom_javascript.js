document.addEventListener("DOMContentLoaded", function () {
  ...
  var orgCreatedCheckbox = document.getElementById("csp-org-created-checkbox");
  var mcaAcceptedCheckbox = document.getElementById("csp-mca-accepted-checkbox");
  var continueBtn = document.getElementById("csp-consent-continue");

  if (!consentPanel || !formPanel || !ncePolicyCheckbox || !orgCreatedCheckbox || !mcaAcceptedCheckbox || !continueBtn) {
    return;
  }
  ...
  function updateContinueButton() {
    var allChecked = ncePolicyCheckbox.checked && orgCreatedCheckbox.checked && mcaAcceptedCheckbox.checked;
  ...
  orgCreatedCheckbox.addEventListener("change", updateContinueButton);
  mcaAcceptedCheckbox.addEventListener("change", updateContinueButton);
  ...
  continueBtn.addEventListener("click", function (e) {
    ...
    if (!ncePolicyCheckbox.checked || !orgCreatedCheckbox.checked || !mcaAcceptedCheckbox.checked) {
      // Show error message
      var errorMsg = document.getElementById("csp-consent-error");
      if (!errorMsg) {
        ...
        errorMsg.textContent = "Please confirm all three requirements above before continuing.";
